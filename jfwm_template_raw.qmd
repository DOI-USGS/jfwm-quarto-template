...
This code chunk would be shown in the resulting document:
...
Whereas this code chunk would be hidden from the resulting document:
...
Using Quarto as a templating workflow does not necessarily guarantee that the resulting rendered document will be 508-compliant or accessible; however, there are some additional guidelines that will improve overall accessibility:
...
These figures and tables demonstrated how to construct a table with formatting changes from default settings.
...
Last, we presented a Python package, `quarto-utils` [@fienen2024quarto] for helping author automate their reference management. 
