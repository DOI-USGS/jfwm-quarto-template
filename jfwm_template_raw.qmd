...
For example when writing agency reports based upon our journal articles, we may stop using Quarto at the final stages because it is easier than continuing to update Quarto documents.
