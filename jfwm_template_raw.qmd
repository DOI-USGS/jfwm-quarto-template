...
* Purpose of this manuscript
  * Present a template for JFWM using Quarto (easy to adapt for current users of RMarkdown and ROxygen)
  * Demonstrate some useful features: table creation and `quarto-utils` package and generating and including a figure
...
* Automated citation management with BibTex

## Background knowledge

* Basic Markdown
* LaTeX equation syntax as needed, such as that required to make $\pi \approx 3.14159$
...
* Ideally, if a manuscript submitted to JWM using this manuscript gets denied (gasp!), fairly easy to modify format to other journal requirements
* Paired with git, easy to track changes and manage collaborative writing through the peer review process
...
The findings and opinions expressed in this manuscript are those of the authors and do not necessarily represent the views of the U.S. Geological Survey.
...
![Exampe of quarto workflow.](./quarto.jpg){#fig-quarto}
