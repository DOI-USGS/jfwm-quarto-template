...
The remaining purpose of our paper is to present our Quarto template for this journal [@erickosn2023quarto].
...
* Also, scientific workflow that differs by authors
  * Erickson will often use 3 files: For example (1) format data (2) run a long bayesian model and (3) call an R script from a Quarto file to produce a summary report
...
* Applications to other systems such as reports (key is to create template)
  ...
  * Easy to change reference managers
  * Ease of reformatting also allows for easy reformatting a resubmitting  
